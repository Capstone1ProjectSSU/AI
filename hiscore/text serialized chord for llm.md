LLM-Chart Parser Specification
==============================

**Version:** 1.3 **Date:** 2025-10-20
...
3.  **Tuplet (`(...)`):** A tuplet is a single top-level element. The chords _inside_ the tuplet are played equally within the duration assigned to the tuplet as a whole.
